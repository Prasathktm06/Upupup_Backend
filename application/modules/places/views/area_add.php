...
<form class="form-horizontal" action="<?=base_url('places/area_add')?>" method="post">
...
<input type="text" name="area" id="area" class="form-control"  placeholder="Area Name" value="" required="required">
