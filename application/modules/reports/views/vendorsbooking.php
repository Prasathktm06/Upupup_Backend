...
<div class="content-wrapper">
     <section class="content-header">
          ...
          <div class="col-md-8" >
                ...
                <a href="<?php echo base_url();?>reports/vendors_excel" data-toggle="tooltip"  class="btn-info btn-demo pull-right btn-warning" style="margin-top: -29px;margin-right: -358px;background-color: #12c5f5;">Download  <i class="fa fa-download "></i></a>
                <?php } ?>
                              ...
                              <table id="example1" class="table table-bordered table-hover">
                                   ...
                                   <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <!--<?=($value['court_cost']*count($value['booked_slots']))*$value['booked_capacity']?>-->
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form role="form" method="post" action="<?=base_url();?>reports/vendors_booking">
                            <div class="box-body">
