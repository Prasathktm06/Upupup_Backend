...
<div class="content-wrapper">
     <section class="content-header">
          <h1>Report</h1>
          <div class="col-md-8" > 
                <a href="<?=base_url();?>reports/venue_excel" data-toggle="tooltip"  class="btn-info btn-demo pull-right btn-warning" style="margin-top: -29px;margin-right: -358px;background-color: #12c5f5;">Download  <i class="fa fa-download "></i></a> 
                                   ...
                                   <table id="example1" class="table table-bordered table-hover">
                                        <thead>
                                             <tr>
                                                  ...
                                                  <th class="text-center">Venue Added Date</th>
                                                  <!-- <th class="text-center">Maximum Utilized Slots</th> -->
                                             </tr>
                                        </thead>
                                        <tbody>
                                             ...
                                             <tr>
                                                  ...
                                                  <td class="text-center"><?=$value['total_hours']?></td>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form role="form" method="post" action="<?=base_url();?>reports/venue_list">
                            <div class="box-body">
