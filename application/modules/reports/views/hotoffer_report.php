...
<div class="content-wrapper">
     <section class="content-header">
          <h1>Report</h1>
          <div class="col-md-8" >
                <?php if (count($hotoffer)>0) { ?>
                <a href="<?php echo base_url();?>reports/hotoffer_excel" data-toggle="tooltip"  class="btn-info btn-demo pull-right btn-warning" style="margin-top: -29px;margin-right: -358px;background-color: #12c5f5;">Download  <i class="fa fa-download "></i></a>
                <?php } ?>
                ...
                <?php $_SESSION['hotoffer']=$hotoffer; ?>
     </section>
                              ...
                              <table id="example1" class="table table-bordered table-hover">
                                   <thead>
                                        <tr>
                                            ...
                                            <th class="text-center">Sports Name</th>
                                            <th class="text-center">Court Name</th>
                                            <th class="text-center">Slot</th>
                                            <th class="text-center">Hot Offer %</th>
                                            <th class="text-center">Date of Booking</th>
                                            <th class="text-center">Booking ID</th>
                                        </tr>
                                   </thead>
                                   <tbody>
                                        <?php $i=1; foreach ($hotoffer as $key => $value) { ?>
                                        <tr>
                                            ...
                                            <td class="text-center"><?=date( ' h:i:s A ',strtotime($value['court_time']))?></td>
                                            <td class="text-center"><?=$value['precentage']?></td>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form role="form" method="post" action="<?=base_url();?>reports/hotoffer_report">
                            <div class="box-body">
