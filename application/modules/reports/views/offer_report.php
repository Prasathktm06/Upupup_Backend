...
<div class="content-wrapper">
     <section class="content-header">
          ...
          <div class="col-md-8" >
                ...
                <a href="<?php echo base_url();?>reports/bookedoffer_excel" data-toggle="tooltip"  class="btn-info btn-demo pull-right btn-warning" style="margin-top: -29px;margin-right: -358px;background-color: #12c5f5;">Download  <i class="fa fa-download "></i></a>
                <?php } ?>
                              ...
                              <table id="example1" class="table table-bordered table-hover">
                                   <thead>
                                        <tr>
                                            ...
                                            <th class="text-center">Offer Rate</th>
                                            <th class="text-center">Offer Validity Dates</th>
                                            <th class="text-center">Offer Validity Time</th>
                                            <th class="text-center">Offer Validity Days</th>
                                            <th class="text-center">no. of bookings</th>
                                            <th class="text-center">Booking Id's</th>
                                        </tr>
                                   </thead>
                                   <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center"><?=date( ' d M Y ',strtotime($value['start']))?> - <?=date( ' d M Y ',strtotime($value['end']))?></td>
                                            <td class="text-center"><?=date( ' h:i:s A ',strtotime($value['start_time']))?> - <?=date( ' h:i:s A ',strtotime($value['end_time']))?></td>
                                            <td class="text-center"><?=$value['days']?></td>
                                            <td class="text-center"><?=$value['booking_count']?></td>
                                            <td class="text-center"><?=$value['booked_id']?></td>   
                                        </tr>
                                        <?php $i++;} ?>
                                   </tbody>
                                   <!-- <tfoot>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form role="form" method="post" action="<?=base_url();?>reports/offer_report">
                            <div class="box-body">
