                                        ...
                                        <tr>
                                           ...
                                           <td class="text-center" style="width: 15%">
                                              <?php if($value['status']==1){?>
                                               ...
                                               <a href="<?=base_url()?>hot_offer/change_not_status/<?=$value['id']?>/<?=$value['status']?>/<?=$value['location_id']?>" type="button" class="btn btn-success">Active</i></a>
                                               
                                              <?php } else{?>
                                                        
                                                <a href="<?=base_url()?>hot_offer/change_not_status/<?=$value['id']?>/<?=$value['status']?>/<?=$value['location_id']?>" type="button" class="btn btn-danger">Inactive</i></a>
                                              <?php } ?>
                                            </td>   
                                            <?php } ?>
