...
class Hotoffer_model extends CI_model {
	...
	public function get_notification_list(){
		$this->db->select('hot_offer_notification.id,hot_offer_notification.status,locations.location,hot_not_setting.name as notification_name,hot_offer_notification.time1,hot_offer_notification.time2');
