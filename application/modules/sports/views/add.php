...
<div class="box-body">
<form class="form-horizontal" action="<?=base_url('sports/add')?>" method="post" enctype="multipart/form-data">
<div class="box-body">
<div class="form-group">
<label for="sports" class="col-sm-2 control-label">Sports</label>

<div class="col-sm-6">
<input type="text" name="sports" id="sports" class="form-control"  placeholder="Sports Name" value="" required="required">
</div>
</div>
    <div class="form-group" >
