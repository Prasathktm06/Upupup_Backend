          ...
          <div class="row">
               <div class="col-xs-6">
                    <div class="box">
                         ...
                         <div class="box-body">
                              <form action="<?= base_url('places/bulk_upload_area')?>" method="post" enctype="multipart/form-data">
                              ...
                              <a class="pull-right text-success" download href="<?=base_url();?>files/area.xlsx">Download sample</a>
                         </div>
                    </div>
               </div>
               <div class="col-xs-6">
