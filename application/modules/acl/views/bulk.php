...
<div class="box-body">
<form action="<?= base_url('acl/user/bulk')?>" method="post" enctype="multipart/form-data">
...
<a class="pull-right text-success" download href="http://app.appzoc.com/upupup/files/user.csv">Download sample</a>
</div>
