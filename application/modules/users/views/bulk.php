...
<div class="box-body">
<form action="<?= base_url('users/bulk')?>" method="post" enctype="multipart/form-data">
<div class="form-group">
<label for="venue" class="col-sm-5 control-label">CSV File!</label>
...
<div class="form-group">
  ...
  <a class="pull-right text-success" download href="http://app.appzoc.com/upupup/files/appUsers.csv">Download sample</a>
</div>
...
<div class="box-body">
 <ul>
                    ...
                    <li>Use * to seperate areas and sports</li>
                  </ul>
