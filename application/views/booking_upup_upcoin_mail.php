...
<div class="row" style="border-style: solid;border-color: black;border-width: 5px;margin: 10%;margin-top: 0;font-family: 'Copperplate / Copperplate Gothic Light, sans-serif';" >
	...
	<div class="col-md-12 " style="margin-bottom: 25px;">
		<div class="col-md-4">
			<img style=" width: 194px; height: 72px;margin-left:1%;" id="venue_image" src="<?=$data['booking']->image?>" height="50" width="50" >
		...
		<div class="col-md-12" style="padding:2%">
			<table style="width: 100%;background-color: pink;" >
				...
				<tr style="border-style:dotted">
					...
					<td>:</td>
					<td></td>
					<td> <?=$data['off_amount']+$data['service_charge']?>.00</td>
				</tr>
				<tr style="border-style:dotted">
					<td>3</td>
					<td>Sevice Charge</td>
