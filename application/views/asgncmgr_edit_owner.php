...
<div class="main" style="padding:8%;border-style:double;">
	...
	<?php if($data['owner_name']==$data['assigned_mgr_name']){ ?> You have reassigned the following courts to <?php }else{ ?> <?=$data['assigned_mgr_name']  ?>( <?=$data['assigned_mgr_phone'] ?> ) reassigned the following courts to <?php } ?> <?=$data['mgr_role']  ?> ( <?=$data['mgr_name']  ?> / <?=$data['mgr_phone']  ?> )  <br>
	courts : <?=$data['court_names']  ?> <br>
	venue : <?=$data['venue']  ?>
