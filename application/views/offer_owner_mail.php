...
<div class="main" style="padding:8%;border-style:double;">
	...
	<?php if($data['owner_name']==$data['vowner']){ ?> You have added <?php }else{ ?> <?=$data['role']  ?>  <?=$data['vowner'] ?> (<?=$data['phone']  ?>) <?php } ?> an offer at <?=$data['venue_name']  ?> <?php if($data['owner_name']==$data['vowner']){ ?><?php }else{ ?> has added offer <?php } ?>  <br>
