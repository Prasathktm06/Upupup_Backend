...
<html>
  <head>
    ...
    <link rel="stylesheet" media="screen" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.3.0/css/font-awesome.min.css" />
      <link rel="shortcut icon" href="http://app.appzoc.com/upupup/pics/unnamed.png" type="image/png">
    <title>Upupup 404</title>
  ...
  @media screen and (max-width: 485px) {
    ...
    .background-color {
      background-color: rgba(189, 83, 83, 1) !important;
    }
  ...
  <body class="plain error-page-wrapper background-color background-image">
	...
	<div class="head-line secondary-text-color">
			<img src="http://app.appzoc.com/upupup/pics/venue/upupup.png" alt="Upupup">
	</div>
	...
	<div class="buttons-container">
		<a class="border-button" href="javascript:history.go(-1)" target="_blank">Go Back!</a>
