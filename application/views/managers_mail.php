...
Congratulations!! You are now part of the upUPUP family.  <?=$data['mgr_name']  ?> has added you as <?=$data['role']  ?> . Login with the below credentials<br><br>

	Login to  : https://play.google.com/store/apps/details?id=com.dev.gooseberryits.upupup <br>
    Login with   : <?=$data['phone']  ?> <br><br>

	Enjoy your Stay here!! <br><br>
	Cheers, <br>
	Team upUPUP <br>
	Lets Play Again <br><br><br>
	</div>
</div>
